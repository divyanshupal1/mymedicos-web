...
const QuizCard = ({section,category,speciality,quiz,locked}) => {
    ...
    const handleclick = () => {
        router.push(`/test?section=${section}&category=${category}&speciality=${speciality}&id=${quiz.qid}`)
    }
    return (
        <div onClick={handleclick} className='border group border-neutral-300 w-[49%] min-w-[350px] flex items-center justify-between gap-x-4 p-2 px-2 pr-5 rounded-lg hover:bg-[#00BFA6] shadow-sm cursor-pointer'>
