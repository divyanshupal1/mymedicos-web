...
const NeetPgItem = ({item}) => {
    return (
        <div className="w-full h-full flex gap-x-3 justify-between px-10 items-center aspect-[10/4] bg-blue-50 max-xl:aspect-[10/5] max-lg:aspect-[11/7] max-md:aspect-[11/8] max-sm:aspect-[11/16]">
