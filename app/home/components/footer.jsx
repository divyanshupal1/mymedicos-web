                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <img src="/images/logo.svg" className="h-8 me-3" alt="FlowBite Logo" />
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="https://tailwindcss.com/" className="hover:underline">Medmy</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Terms and Conditions</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <a href="#" className="hover:underline">+91 6360354294</a>
                                </li>
                            </ul>
                        </div>
                    </div>
