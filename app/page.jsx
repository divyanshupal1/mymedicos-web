      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="pt-8 px-4 mx-auto max-w-[1800px] text-center lg:pt-16 lg:px-12">
          ...
          <div className=" mb-8 space-x-4 flex items-center justify-center  max-w-screen-xl mx-auto">
            <div className="flex w-full max-w-48 h-14 px-3 bg-black text-white rounded-lg items-center justify-center">
              <div className="mr-3">
            ...
            <div className="flex  w-full max-w-48 h-14 px-3 bg-black text-white rounded-xl items-center justify-center">
              <div className="mr-3">
