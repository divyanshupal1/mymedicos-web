...
const Sidebar = () => {
    ...
    return (
        <div className={`sidebar border-r-2 border-slate-100 h-full min-h-screen  w-1/5 max-md:w-full min-w-[200px] max-w-[300px] sticky top-0 max-md:absolute bg-background transition-all ${open?"max-md:translate-x-0":"max-md:-translate-x-full"}`}>
            {
